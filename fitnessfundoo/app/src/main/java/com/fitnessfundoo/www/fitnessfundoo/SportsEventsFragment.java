 ...
 */
public class SportsEventsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState){
        View rootView = inflater.inflate(R.layout.events_fragments,container,false);
        super.getActivity();
...
/*
                  ...
                  alertbox.setMessage("Do you want to edit this Event!");
    ...
    public void function3(int id){
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/sharer/sharer.php?u=http://www.fitnessfundoo.in/Events/" + event.getUrl()));
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private SportsEventsFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final SportsEventsFragment.ClickListener clickListener) {

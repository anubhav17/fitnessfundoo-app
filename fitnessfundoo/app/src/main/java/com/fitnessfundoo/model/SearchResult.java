...
/**
 * Created by Anubhav on 27-03-2016.
 */

public class SearchResult {

    private String title,address, thumbnailUrl,e_Stime,e_Etime,no_participants,description,
            contact_no,email,street,colony,city,state,country,pin,event_host_id,date_created,cat,number_visible,url,email_visible;
    //private int year;
    ...
    public SearchResult(String title,String e_Stime,String e_Etime,String no_participants,String description,String contact_no,String email,
                       String street,String colony,String city,String state,String country,String pin,String event_host_id,
                       String date_created,String cat,String number_visible,String lon,String thumbnailUrl,String address , String event_date,String lat,String url,String email_visible) {
        this.title = title;

...
/**
 * Created by Anubhav on 21-04-2016.
 */

public class FavoriteEvents extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_favourite_events, container, false);
        super.getActivity();
...
//        Toolbar toolbar =  (Toolbar) rootView.findViewById(R.id.toolbar);
    ...
    private void getFavEvents() {
        ...
        StringRequest eventReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOAD_FAV_EVENT, new Response.Listener<String>() {
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private FavoriteEvents.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final FavoriteEvents.ClickListener clickListener) {

...
/**
 * Created by Anubhav on 02-05-2016.
 */

public class MyFollowings extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_followings, container, false);
        super.getActivity();
        ...
        {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("My Followings");
...
//        recyclerView.setLayoutParams(p);
    ...
    private void loadfollowings(){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_USER_FOLLOWINGS, new Response.Listener<String>() {
...
//        recyclerView.setLayoutParams(p);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private MyFollowings.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final MyFollowings.ClickListener clickListener) {

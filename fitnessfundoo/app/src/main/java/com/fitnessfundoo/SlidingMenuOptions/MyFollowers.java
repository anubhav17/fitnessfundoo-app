...
/**
 * Created by Anubhav on 30-04-2016.
 */
public class MyFollowers extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_followers, container, false);
        super.getActivity();
        ...
        {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("My Followers");
...
//        recyclerView.setLayoutParams(p);
    ...
    private void loadfollowers(){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_USER_FOLLOWERS, new Response.Listener<String>() {
...
//        recyclerView.setLayoutParams(p);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private MyFollowers.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final MyFollowers.ClickListener clickListener) {

...
import com.fitnessfundoo.adapter.EventListNearByAdapter;
...
/**
 * Created by Anubhav on 17-04-2016.
 */

public class EventsNearBy extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private EventListNearByAdapter adapterList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_event_near_by, container, false);
        super.getActivity();
...
//        Toolbar toolbar =  (Toolbar) rootView.findViewById(R.id.toolbar);
        ...
        HashMap<String, String> dist_val = db.getDistVal("event");
        ...
        adapterList = new EventListNearByAdapter(eventList);
    ...
    public void getLocation(){
        ...
        if(gps.canGetLocation()){
          ...
          //  Toast.makeText(getActivity(), "Identifying Your lat and long!!. " + longitude +latitude , Toast.LENGTH_LONG).show();
            // \n is for new line
...
//                Toast.makeText(getActivity(), "Your Location is - \nLat: " + latitude + "\nLong: " + longitude, Toast.LENGTH_LONG).show();
            ...
            {
                Toast.makeText(getActivity(), "Identifying Your Location.Please wait!!. ", Toast.LENGTH_LONG).show();
            }
    ...
    public void function3(int id){
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.in/sharer/sharer.php?u=http://www.fitnessfundoo.com/Events/" + event.getUrl()));
    ...
    private void getNearByEvent() {
        ...
        StringRequest eventReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOAD_EVENT_NEARBY, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (!error) {
                       ...
                       /*     if (rank >= limit_val1)
                            ...
                            event.setDistance(jsonArray.getString("distance"));
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private EventsNearBy.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final EventsNearBy.ClickListener clickListener) {
